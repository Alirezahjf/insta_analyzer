...
class BotSettings:
    ...
    startup_login: bool = False  # BOT_STARTUP_LOGIN — بررسی/لاگین در شالِ ربات (پیش‌فرض: خاموش)
    ...
    def from_env(cls) -> "BotSettings":
        ...
        if admin_raw:
            try:
                ...
                admin_id = None
        startup_login = env_str("BOT_STARTUP_LOGIN") in ("1", "true", "yes", "on")
        return cls(
